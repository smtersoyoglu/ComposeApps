...
fun getWordList(): List<Word> {
    return listOf(
        ...
        Word(
            ...
            "Şişe",
            "Bottle",
            R.drawable.bottle_card1,
            sentence = "He is drinking water from a bottle."
        ),
        Word(
            7,
            "Saat",
            "Watch",
            R.drawable.watch_card,
            sentence = "She looked at her watch to check the time."
        ),
        Word(
            8,
            "Tavşan",
            ...
            sentence = "The rabbit is hopping around the garden."
        ),
    )
}